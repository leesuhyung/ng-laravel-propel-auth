...
$serviceContainer->setAdapterClass('scv', 'mysql');
$manager = new \Propel\Runtime\Connection\ConnectionManagerSingle();
$manager->setConfiguration(array (
  'classname' => 'Propel\\Runtime\\Connection\\ProfilerConnectionWrapper',
  'dsn' => 'mysql:host=db.local;port=3306;dbname=scv',
  'user' => 'homestead',
  'password' => 'secret',
  'options' =>
  array (
...
$serviceContainer->setConnectionManager('scv', $manager);
$serviceContainer->setDefaultDatasource('scv');

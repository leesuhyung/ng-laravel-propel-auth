...
class BoardTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\App\\Models\\Board';
     ...
     */
    const COL_ID = 'board.id';

    /**
     * the column name for the user_id field
     */
    const COL_USER_ID = 'board.user_id';

    /**
     * the column name for the entity field
     */
    const COL_ENTITY = 'board.entity';

    /**
     * the column name for the title field
     */
    const COL_TITLE = 'board.title';

    /**
     * the column name for the contents field
     */
    const COL_CONTENTS = 'board.contents';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'board.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'board.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'UserId', 'Entity', 'Title', 'Contents', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'userId', 'entity', 'title', 'contents', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(BoardTableMap::COL_ID, BoardTableMap::COL_USER_ID, BoardTableMap::COL_ENTITY, BoardTableMap::COL_TITLE, BoardTableMap::COL_CONTENTS, BoardTableMap::COL_CREATED_AT, BoardTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'user_id', 'entity', 'title', 'contents', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'UserId' => 1, 'Entity' => 2, 'Title' => 3, 'Contents' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'userId' => 1, 'entity' => 2, 'title' => 3, 'contents' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(BoardTableMap::COL_ID => 0, BoardTableMap::COL_USER_ID => 1, BoardTableMap::COL_ENTITY => 2, BoardTableMap::COL_TITLE => 3, BoardTableMap::COL_CONTENTS => 4, BoardTableMap::COL_CREATED_AT => 5, BoardTableMap::COL_UPDATED_AT => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'user_id' => 1, 'entity' => 2, 'title' => 3, 'contents' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Models\\Board');
        $this->setPackage('');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, 10, null);
        $this->addForeignKey('user_id', 'UserId', 'INTEGER', 'user', 'id', true, 10, null);
        $this->addColumn('entity', 'Entity', 'VARCHAR', true, 45, 'info');
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(BoardTableMap::COL_ID);
            $criteria->addSelectColumn(BoardTableMap::COL_USER_ID);
            $criteria->addSelectColumn(BoardTableMap::COL_ENTITY);
            $criteria->addSelectColumn(BoardTableMap::COL_TITLE);
            $criteria->addSelectColumn(BoardTableMap::COL_CONTENTS);
            $criteria->addSelectColumn(BoardTableMap::COL_CREATED_AT);
            $criteria->addSelectColumn(BoardTableMap::COL_UPDATED_AT);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Models\Board) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(BoardTableMap::DATABASE_NAME);
            $criteria->add(BoardTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(BoardTableMap::COL_ID) && $criteria->keyContainsValue(BoardTableMap::COL_ID) ) {
